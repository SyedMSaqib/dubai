  ...
  return (
    <footer className="w-full bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8 justify-items-center">
          ...
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-white font-medium mb-7">Dubai Tourism</h4>
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-white ">
              ©<a href="">Dubai Tourism</a> 2024, All rights reserved.
            </span>
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                href=""
                className="w-9 h-9 rounded-full bg-black flex justify-center items-center hover:bg-green-500"
              >
                <svg
