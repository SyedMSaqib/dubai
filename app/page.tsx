...
export default function Home() {
  return (
    <>
      <ImageCarousel />
      <div className="mx-auto  xl:max-w-[60vw] px-4 sm:px-6 lg:px-8 mt-10">
        <h3 className=" text-center text-xl sm:text-2xl lg:text-3xl font-bold">Why Book Us?</h3>
        <div className="mx-auto gap-y-7 grid grid-cols-2 md:grid-cols-4  xl:max-w-[60vw] px-4 sm:px-6 lg:px-8 mt-10">
          <WhyBookUs
      ...
      <div className="w-full bg-[#74DFA2] mt-[50px] py-[100px] sm:py-[150px]">
        <div className="mx-auto xl:max-w-[60vw] px-4 sm:px-6 lg:px-8">
